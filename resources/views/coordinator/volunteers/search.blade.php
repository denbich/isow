...
@section('title') {{ __('Szukaj wolontariuszy') }} @endsection
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item ps-1 pt-1">
            ...
            <div class="collapse show" id="volunteers">
                <ul class="nav ms-4">
                    <li class="nav-item">
                        <a href="{{ route('c.v.search') }}" class="nav-link active">
  ...
  <main class="main-content position-relative border-radius-lg ">
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder text-white mb-0">{{ __('Szukaj wolontariuszy') }}</h6>
          </nav>
    ...
    <div class="container-fluid py-4 min-vh-100">
        <div class="row">
         ...
         <div class="card">
            <div class="card-header"><h5 class="mb-0">{{ __('Szukaj wolontariuszy') }}</h5></div>
            <div class="card-body">
            ...
            @isset($_GET['q'])
                ...
                @else
                    ...
                    @else
                        <h3 class="text-center text-danger">{{ __('Nie znaleziono wolontariuszy') }}</h3>
                    @endif
                @endif
            @endisset
          </div>
        ...
        <form action="{{ route('c.v.exportlist') }}" method="post">
            <div class="modal-body pt-1">
              <h5 class="text-center mt-3 mb-4">{{ __('Wybierz typ pliku') }}</h5>
                  @csrf
                  <input type="hidden" name="q" value="@isset($_GET['q']) {{ $_GET['q'] }} @endisset">
                  <div class="row">
                    <div class="col-4">
