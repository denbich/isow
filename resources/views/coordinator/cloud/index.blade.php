...
@section('title') {{ __('Chmura') }} @endsection
...
<div class="min-height-300 bg-primary position-absolute w-100" id="background-color-div"></div>
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          ...
          <li class="nav-item ps-1 pt-1">
            <a class="nav-link active" href="{{ route('c.cloud.index') }}">
  ...
  <main class="main-content position-relative border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-white active" aria-current="page">{{ __('Chmura') }}</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">{{ __('Chmura') }}</h6>
          </nav>
    ...
    <div class="container-fluid py-4 min-vh-100">
        <div class="card">
            <div class="card-body">
                <h4 class="text-danger text-center">{{ __('Chmura jest niedostępna! Spróbuj ponownie później') }}</h4>
            </div>
        </div>
    </div>
