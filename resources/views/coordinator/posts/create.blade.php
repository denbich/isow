            ...
            <div class="collapse show" id="posts">
                <ul class="nav ms-4">
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="{{ route('c.post.create') }}" class="nav-link active">
  ...
  <main class="main-content position-relative border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-white" aria-current="page">{{ __('Post') }}</li>
              <li class="breadcrumb-item text-sm text-white active" aria-current="page">{{ __('Nowy') }}</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">{{ __('Nowy post') }}</h6>
          </nav>
    ...
    <div class="container-fluid py-4 min-vh-100">
        <div class="row">
         ...
         <div class="card">
            <div class="card-header"><h5 class="mb-0">{{ __('Utwórz nowy post') }}</h5></div>
              <div class="card-body">
                        <form action="{{ route('c.post.store') }}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-4 order-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" max="255" value="{{ old('title', '') }}" required>
                                      @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="radio" id="type_general" name="post_type" class="form-check-input" value="general" checked required>
                                            <label class="custom-control-label" for="type_general">{{ __('Ogólny') }}</label>
                                        </div>
                                          <div class="form-check">
                                            <input type="radio" id="type_form" name="post_type" class="form-check-input" value="form" required>
                                            <label class="custom-control-label" for="type_form">{{ __('Do formularza') }}</label>
                                          </div>
                                          <div class="d-none" id="form_select_div">
                                ...
                                <div class="col-lg-8 order-lg-1">
                                    <div class="form-group">
                                        <label for="content">{{ __('Zawartość') }}</label>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6">
                                    <button class="btn btn-success w-100 my-2" id="create-button-post" type="submit">{{ __('Utwórz post') }}</button>
                                </div>
                            </div>
                        </form>
              </div>
