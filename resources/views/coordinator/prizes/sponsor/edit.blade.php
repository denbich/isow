    ...
    <div class="container-fluid py-4 min-vh-100">
        <div class="row">
            <div class="col-lg-6 col-12 d-flex ms-auto">
               <a href="{{ route('c.sponsor.show', [$sponsor->ivid]) }}" class="btn btn-icon bg-gradient-dark ms-auto">
            ...
            <div class="my-2">
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">{{ __('Edycja sponsora') }}</h5>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <label for="upload_image" class="w-100">
                                <a class="btn btn-primary btn-icon w-100 text-white">
                                    ...
                                    <span class="btn-inner--text">{{ __('Zmień logo sponsora') }}</span>
                                </a>
                        ...
                        <div class="col-lg-9">
                            <div class="row">
                                <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" max="255" value="{{ $sponsor->name }}" required>
                                      @error('name')
                                        <div class="text-danger w-100 d-block">
                                            {{ $message }}
                                        </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="address" max="255" value="{{ $sponsor->address }}" required>
                                      @error('address')
                                        <div class="text-danger w-100 d-block">
                                            {{ $message }}
                                        </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control @error('website') is-invalid @enderror" name="website" id="website" value="{{ $sponsor->website }}" max="255">
                                      @error('website')
                                        <div class="text-danger w-100 d-block">
                                            {{ $message }}
                                        </div>
                                  ...
                                  <div class="form-group">
                                      <label for="facebook" class="form-control-label">Facebook (Nie wymagany)</label>
                                          <div class="input-group">
                                              ...
                                              <input type="text" class="form-control @error('facebook') is-invalid @enderror" name="facebook" id="facebook" max="255" value="{{ $sponsor->facebook }}" aria-describedby="basic-addon1">
                                          </div>
                                        @error('facebook')
                                          <div class="text-danger w-100 d-block">
                                              {{ $message }}
                                ...
                                <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="description" max="255" value="{{ $sponsor->description }}">
                                      @error('description')
                                        <div class="text-danger w-100 d-block">
                                            {{ $message }}
                                        </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="tel" class="form-control @error('telephone') is-invalid @enderror @error('phone') is-invalid @enderror" name="telephone" id="telephone" max="255" value="{{ $sponsor->telephone }}" required>
                                      @error('telephone')
                                        <div class="text-danger w-100 d-block">
                                            {{ $message }}
                                        </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" max="255" value="{{ $sponsor->email }}">
                                      @error('email')
                                        <div class="text-danger w-100 d-block">
                                            {{ $message }}
                                        </div>
                                  ...
                                  <div class="form-group">
                                      <label for="instagram" class="form-control-label">Instagram (Nie wymagany)</label>
                                          <div class="input-group">
                                              ...
                                              <input type="text" class="form-control @error('instagram') is-invalid @enderror" name="instagram" id="instagram" max="255" aria-describedby="basic-addon2" value="{{ $sponsor->instagram }}">
                                          </div>
                                          @error('instagram')
                                        <div class="text-danger w-100 d-block">
                                            {{ $message }}
                            ...
                            <button type="submit" class="btn btn-primary w-100">{{ __('Zakutalizuj sponsora') }}</button>
                        </div>
                    </div>
                </form>
                </div>
...
@if (session('edit_sponsor'))
<script>
Swal.fire({
    icon: 'success',
    title: 'Sponsor został zaktualizowany pomyślnie!',
