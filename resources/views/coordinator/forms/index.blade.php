    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder text-white mb-0">{{ __('Lista formularzy') }}</h6>
          </nav>
    ...
    <div class="container-fluid py-4 min-vh-100">
        <div class="row">
            <div class="col-lg-6 col-12 d-flex ms-auto">
               ...
               <a href="{{ route('c.form.archive') }}" class="btn btn-icon bg-gradient-dark ms-3">
                <span class="btn-inner--icon me-2"><i class="fa-solid fa-box-archive"></i></span>
               <span class="btn-inner--text">{{ __('Archiwum') }}</span>
            </a>
            </div>
         </div>
         ...
         <div class="row">
            ...
            <div class="card col-12 mb-8">
                <div class="card-body py-3 d-flex flex-row align-items-center justify-content-between">
                    <h4 class="text-center text-danger w-100 my-3">{{ __('Brak aktywnych formularzy!') }}</h4>
                </div>
            </div>
...
@push('scripts')
@if (session('delete_form'))
<script>
Swal.fire({
    icon: 'success',
    title: 'Formularz został usunięty pomyślnie!',
