<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
        <form action="{{ route('v.search') }}" method="get">
            <div class="input-group">
                <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
                <input type="text" class="form-control" placeholder="{{ __('volunteer.menu.search') }}" name="q" value="@isset($_GET['q']){!! $_GET['q'] !!}@endisset">
              </div>
        </form>
    </div>
        ...
        <li class="nav-item dropdown pe-2 d-flex align-items-center">
          ...
          <ul class="dropdown-menu dropdown-menu-end px-4 py-3 me-sm-n4 w-auto" aria-labelledby="dropdownProfileButton">
              <div class="dropdown-header text-dark">
                <span class="nav-link-text h6">Witaj!</span>
                </div>
            <li class="mb-2">
              <a class="dropdown-item border-radius-md" href="{{ route('v.profile') }}">
                  <i class="fa-solid fa-user text-primary text-sm opacity-10"></i>
                <span class="nav-link-text ms-1">{{ __('volunteer.profile.title') }}</span>
              </a>
            </li>
            <li class="mb-2">
              <a class="dropdown-item border-radius-md" href="{{ route('v.settings') }}">
            ...
            <li class="mb-2">
              <a class="dropdown-item border-radius-md" href="{{ route('v.id') }}">
                ...
                <span class="nav-link-text ms-1">{{ __('volunteer.menu.dropdown.id') }}</span>
              </a>
            </li>
            <li>
