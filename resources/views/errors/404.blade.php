        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-7 mx-auto text-center">
                    <h1 class="display-1 text-bolder text-primary">{{ __('Błąd 404') }}</h1>
                    <h2>{{ __('Nie znaleziono strony') }}</h2>
                    <p class="lead">{{ __('Sugerujemy przejście do strony głównej podczas rozwiązywania tego problemu.') }}</p>
