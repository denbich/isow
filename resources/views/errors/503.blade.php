        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-7 mx-auto text-center">
                    <h1 class="display-1 text-bolder text-primary">{{ __('Błąd 503') }}</h1>
                    <h2>{{ __('Usługa niedostępna') }}</h2>
                    <p class="lead">{{ __('Skontaktuj się z administratorem w celu naprawienia błędu.') }}</p>
