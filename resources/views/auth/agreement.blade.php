...
@section('title') {{ __('index.agreement.title') }} @endsection
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">{{ __('index.agreement.title') }}</h1>
            <h5 class="text-lead text-white">{{ __('index.agreement.text.text1') }} <b>{{ __('index.agreement.text.text2') }}</b> {{ __('index.agreement.text.text3') }} <b>{{ __('index.agreement.text.text4') }}</b> {{ __('index.agreement.text.text5') }}</h5>
        ...
        <div class="col-xl-6 col-lg-7 col-md-8 mx-auto">
          <div class="card z-index-0">
            <div class="card-body px-lg-5 py-lg-5 text-center">
              <form method="post" action="{{ route('new.agreement') }}" role="form" enctype="multipart/form-data" id="newagreement_form">
                @csrf
                    <div class="form-group mb-2">
                        ...
                        <input type="file" class="form-control" accept=".pdf,.png,.jpg,.jepg" name="agreement[]" multiple required>
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-2" id="newagreement_button">{{ __('index.agreement.button') }}</button>
                </div>
              </form>
            </div>
          </div>
...
<script>
    $('#newagreement_form').submit(function(){
        $('#newagreement_button').prop('disabled', true);
        $('#newagreement_button').prepend('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> ');
    });
</script>
@endpush
