      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">{{ __('index.password.reset.title') }}</h1>
            <h5 class="text-lead text-white"></h5>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form method="post" action="{{ route('password.email') }}" role="form" id="pwdreset_form">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" placeholder="np. email@example.com" autofocus>
                    @error('email')
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-2" id="pwdreset_button">{{ __('index.password.reset.button') }}</button>
