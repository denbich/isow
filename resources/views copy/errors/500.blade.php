    ...
    <div class="container text-primary">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item text-center">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="https://facebook.com/wolontariat.rybnik" target="_blank"><i class="fa-brands fa-facebook-square"></i> {{ __('home.socialmedia.facebook') }}</a>
                        <a class="dropdown-item" href="https://instagram.com/wolontariat.rybnik" target="_blank"><i class="fa-brands fa-instagram"></i> {{ __('home.socialmedia.instagram') }}</a>
                      </div>
                    </div>
                  </li>
            </li>
            @auth
            <li class="nav-item">
                <a href="{{ route('loginauth') }}" class="nav-link text-center">
                    <span class="nav-link-inner--text">{{ __('Panel') }}</span>
                </a>
            </li>
            @endauth
          ...
          <div class="header-body text-center mb-8">
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-8 col-md-8 px-5">
                <h1 class="display-1 text-white mt-3 font-weight-700">{{ Str::upper(__('Błąd 500')) }}</h1>
                <h1 class="display-3 text-white mt-3">{{ __('Błąd serwera') }}</h1>
                <h1 class="display-6 text-white mt-3">{{ __('Jeśli widzisz tą stronę, skontaktuj się z administratorem ISOW') }}: <a href="mailto:administrator@wolontariat.rybnik.pl" class="font-weight-700">administrator@wolontariat.rybnik.pl</a></h1>
                <a href="{{ route('home') }}" class="btn btn-neutral btn-icon text-center btn-lg mt-2">
                    <span class="btn-inner--icon">
                      <i class="fas fa-sign-in-alt mr-2"></i>
                    </span>
                    <span class="nav-link-inner--text">{{ Str::upper(__('home.title')) }}</span>
                  </a>
              </div>
            </div>
          </div>
