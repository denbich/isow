              ...
              <div class="card">
                <div class="card-body">
                    ...
                    @if ($post->form_id == 0)
                        <p>Ogólny</p>
                    @else
                        <p><a href="{{ route('c.form.show', [$post->form_id->ivid]) }}">Do formularza #{{ $post->form_id->ivid }}</a></p>
                    @endif
                    <hr class="my-2">
                    <h3 class="text-center">Opcje</h3>
                    <a href="{{ route('c.post.edit', [$post->ivid]) }}" class="btn btn-success w-100 my-2 text-white">Edytuj post</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="ModalLabel">Usuń posta</h5>
