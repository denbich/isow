            ...
            <div class="col-lg-3 order-lg-2">
              <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('c.prize.orderconfirmation', [$order->ivid]) }}" class="btn btn-primary w-100 my-2">Generuj potwierdzenie PDF</a>
                </div>
              </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row my-3">
                        <div class="col-md-6">
                            ...
                            <a href="{{ route('c.v.volunteer', [$user->ivid]) }}"><b>{{ $order->volunteer->firstname." ".$order->volunteer->lastname." (".$order->volunteer->name.")" }}</b></a>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-md-6">
                            <span>Wybrana kombinacja:</span><br>
                            <b>@if ($order->combination == null) Nagroda bez kombinacji @else {{ $order->combination->translate->title }} @endif</b>
                        </div>
                    </div>
                </div>
              </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form action="{{ route('c.prize.changestatus', [$order->ivid])}}" method="post">
            @csrf
