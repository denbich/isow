        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">{{ $category->prize_category_translate->name }}</h6>
            ...
            <div class="col-lg-3 order-lg-2">
              <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('c.prizecategory.edit', [$category->ivid]) }}" class="btn btn-success w-100 my-2 text-white">Edytuj kategorię</a>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <div class="row pt-2">
                        ...
                        <div class="col-lg-6">
                            <h4>Lista nagród w tej kategorii:</h4>
                            <ul>
                                @forelse ($category->prize as $prize)
                                    <li><a href="{{ route('c.prize.show', [$prize->ivid]) }}">{{ $prize->prize_translate->title }}</a></li>
                                @empty
                                <h3>Brak nagród w tej kategorii!</h3>
                                @endforelse
                            </ul>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h3 class="w-100 text-wrap text-center">Czy jesteś pewnien, że chcesz usunąć kategorię "{{ $category->prize_category_translate->name  }}"?</h3>
        </div>
