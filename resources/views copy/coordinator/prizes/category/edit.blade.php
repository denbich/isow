...
<nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
  ...
  <div class="main-content" id="panel">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Edycja kateogrii</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="{{ route('c.dashboard') }}"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item" aria-current="page"><a href="{{ route('c.prizecategory.list') }}">Kategorie</a></li>
    ...
    <div class="container-fluid mt--6">
        <form action="{{ route('c.prizecategory.update', [$category->ivid]) }}" method="post">
            @method('PUT')
            @csrf
                    ...
                    <div class="card">
                      <div class="card-header">
                        <div class="row align-items-center">
                          <div class="col-8">
                            <h3 class="mb-0">Edycja kategorii</h3>
                          </div>
                        </div>
                      </div>
                      <div class="card-body">
                          <div class="row pt-2">
                              <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="name" id="name" max="255" value="{{ $category->prize_category_translate->name }}" required>
                                    @if($errors->has('name'))
                              ...
                              <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description" value="{{ $category->prize_category_translate->description }}" max="255">
                          ...
                          <button class="btn btn-success w-100 my-2" type="submit">Zapisz kategorię</button>
                      </div>
                    </div>
                  </div>
            </div>
...
@section('script')
@if (session('edit_category') == true)
<script>
    Swal.fire({
        icon: 'success',
        title: 'Sukces!',
        text: 'Edycja kategorii zakończyła się pomyślnie!',
