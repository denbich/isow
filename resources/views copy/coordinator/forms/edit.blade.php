            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('c.form.update', [$form->ivid]) }}" method="post" role="form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-3 text-center">
                                <img src="{{ url($form->icon_src) }}" class="w-100" alt="" style="max-height:300px; max-width:300px">
                                <div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    @foreach ($form_positions as $position)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('name_position'.$loop->iteration) ? 'is-invalid' : '' }}" maxlength="255" id="name_position{{ $loop->iteration }}" name="name_position{{ $loop->iteration }}" onkeyup="(counter_name_position({{ $loop->iteration }}))" value="{{ $position->form_position_translate->title }}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control mt-1 {{ $errors->has('desc_position'.$loop->iteration) ? 'is-invalid' : '' }}" rows="3" maxlength="255" id="desc_position{{ $loop->iteration }}" style="resize: none;" name="desc_position{{ $loop->iteration }}" onkeyup="(counter_desc_position({{ $loop->iteration }}))" required>{{ $position->form_position_translate->description }}</textarea>
                                            ...
                                            <div class='row form-group'>
                                                <div class='col-lg-6'>
                                                    ...
                                                    <input type='time' name='start_position{{ $loop->iteration }}' id='start_position{{ $loop->iteration }}' class='form-control' value="{{ $position->start }}" required> </div>
                                                <div class='col-lg-6 form-group'>
                                                    <label for='end_position{{ $loop->iteration }}'>Godzina zakończenia pracy</label>
                                                    <input type='time' name='end_position{{ $loop->iteration }}' id='end_position{{ $loop->iteration }}' class='form-control' value="{{ $position->end }}" required>
                                                    </div>
                                                </div>
