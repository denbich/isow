            ...
            <li class="nav-item active">
                ...
                <div class="collapse show" id="forms">
                  <ul class="nav nav-sm flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('c.form.archive') }}">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
                <a class="btn btn-icon btn-neutral mb-2" href="{{ route('c.form.list') }}">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody class="list">
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="media align-items-center">
                                            <a href="{{ route('c.form.show', [$form->ivid]) }}" class="avatar rounded-circle mr-3">
                                    ...
                                    <td class="text-center text-xl">
                                        <h4>
                                            <a class="mx-1" href="{{ route('c.form.show', [$form->ivid]) }}">
                                                <i class="fas fa-search"></i>
                                            </a>
                                            <a class="mx-1" href="{{ route('c.form.edit', [$form->ivid]) }}">
                                ...
                                @empty <h2 class="text-center text-danger">Brak zarchiwizowanych formularzy!</h2> @endforelse
                            </tbody>
                        </table>
                    </div>
                    @else <h2 class="text-center text-danger">Brak zarchiwizowanych formularzy!</h2> @endif
                </div>
            </div>
...
<script>
    Swal.fire({
        icon: 'success',
        title: 'Sukces!',
        text: 'Formularz został usunięty pomyślnie!',
