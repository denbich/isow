                          ...
                          <div class="row pt-2">
                              <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="name" id="name" max="255" value="{{ $category->form_category_translate->name }}" required>
                                    @if($errors->has('name'))
                              ...
                              <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description" value="{{ $category->form_category_translate->description }}" max="255">
