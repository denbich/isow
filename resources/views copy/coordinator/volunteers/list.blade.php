              ...
              <div class="card-header">
                <div class="row align-items-center">
                  ...
                  <div class="col-4 text-right">
                    ...
                    <a href="#resetpointsmodal" data-toggle="modal" data-target="#resetpointsmodal" class="btn btn-sm btn-primary d-none"><i class="fas fa-times-circle"></i> Resetuj punkty</a>
                  </div>
                </div>
              </div>
                <div class="card-body">
                                  ...
                                  <tr>
                                      ...
                                      <th scope="row">
                                          <div class="media align-items-center">
                                              <a href="{{ route('c.v.volunteer', [$volunteer->ivid]) }}" class="avatar rounded-circle mr-3">
