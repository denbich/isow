                                ...
                                @foreach ($volunteers as $volunteer)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('c.v.agreement', [$volunteer->user->ivid]) }}"><i class="fas fa-search"></i></a>
                                        </td>
                                        <td class="text-center">
                                            <div class="row">
                                                <div class="col">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                          <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('c.v.active') }}" method="post">
                                                                @csrf
                                                                <input type="hidden" name="id" value="{{ $volunteer->user->ivid }}">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                      ...
                                                                      <a href="{{ route('c.v.agreement', [$volunteer->ivid]) }}" target="_blank" rel="noopener noreferrer" class="btn btn-primary">Zobacz zgodę</a>
                                                                  </div>
