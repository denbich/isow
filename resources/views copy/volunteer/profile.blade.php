            ...
            <div class="card card-profile">
              ...
              <div class="card-body pt-0">
                ...
                <div class="text-center">
                  ...
                  <div class="h5 mt-4 d-none">
                    <i class="ni business_briefcase-24 mr-2"></i>{{ __('volunteer.profile.volunteer') }}
                  </div>
                  @if (Auth::user()->google_id != null)
                  <a href="{{ route('volunteer.google.disconect') }}" class="btn btn-neutral btn-icon w-100">
                      <span class="btn-inner--icon"><img src="{{ url('/assets/img/icons/common/google.svg') }}"></span>
                      <span class="btn-inner--text">{{ __('volunteer.settings.login.ungoogle') }}</span>
                    </a>
                  @else
                      <a href="{{ route('google.redirect') }}" class="btn btn-neutral btn-icon w-100">
                          <span class="btn-inner--icon"><img src="{{ url('/assets/img/icons/common/google.svg') }}"></span>
                          <span class="btn-inner--text">{{ __('volunteer.settings.login.google') }}</span>
                      </a>
                  @endif
                </div>
              </div>
...
<script>
    Swal.fire({
        icon: 'success',
        title: 'Sukces!',
        text: 'Połączenie konta z kontem Google zakończyło się pomyślnie!',
        buttonsStyling: false,
        customClass: {
            confirmButton: 'btn btn-success btn-lg' //insert class here
        },
        timer: 4000
    })
    </script>
