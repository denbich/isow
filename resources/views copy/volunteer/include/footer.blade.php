    ...
    <div class="row align-items-center justify-content-lg-between">
      ...
      <div class="col-lg-6">
        <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
                <a href="{{ route('regulations') }}" class="nav-link" target="_blank">{{ __('index.footer.regulations') }}</a>
              </li>
              <li class="nav-item">
                <a href="{{ route('codex') }}" class="nav-link">{{ __('index.footer.codex') }}</a>
              </li>
              <li class="nav-item">
                <a href="{{ route('privacy_policy') }}" class="nav-link" target="_blank">{{ __('index.footer.privacypolicy') }}</a>
              </li>
          </ul>
      </div>
    </div>
