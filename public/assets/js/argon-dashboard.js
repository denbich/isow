...
window.onload = function(){
    ...
    if(getCookie("theme") == "dark")
    {
        ...
        if (navbarBrandImg.includes('logowmr.svg')) {
            var navbarBrandImgNew = navbarBrandImg.replace("logowmr", "logowmrwhite");
          ...
          document.getElementById('background-color-div').classList.remove('bg-primary');
          var progress = (document).getElementsByClassName("progress");
        for(var i = 0; i < progress.length; i++)
        {
            progress.item(i).classList.add('bg-dark');
        }
    } else {
        body.classList.remove('dark-version');
        sidebar.classList.add('bg-white');
        if (navbarBrandImg.includes('logowmrwhite.svg')) {
        var navbarBrandImgNew = navbarBrandImg.replace("logowmrwhite", "logowmr");
        navbarBrand.src = navbarBrandImgNew;
        }
        ...
        document.getElementById('background-color-div').classList.add('bg-primary');
        var progress = (document).getElementsByClassName("progress");
        for(var i = 0; i < progress.length; i++)
        {
            progress.item(i).classList.remove('bg-dark');
        }
    }
}
