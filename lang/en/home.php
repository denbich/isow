...
return [
    ...
    'section1' => [
        'header' => 'About us',
        'article' => [
            'part1' => 'The MOSiR Rybnik Volunteers Group was established in 2017. We associate people of all ages who are interested in helping with the organization of events, and are also willing to develop their own competences. In the early years, the group consisted of over 300 people who chose individual events according to their sports preferences.',
            'part2' => 'As part of our volunteering program, we took part in 3 Erasmus + Sport European projects:',
        ],
    ],
    'section2' => [
        'header' => 'How to join us?',
        'text' => 'Follow a few simple steps to become a MOSiR Rybnik volunteer!',
        'point1' => 'Click the button below to go to the registration form and fill in the required fields',
         'point2' => 'You are sending agreement as a photo (JPG or PNG) or as a PDF file. (You will find samples of agreements during registration) ',
         'point3' => 'After registration you can log in! (You cannot sign up for any event until activated by the coordinator)',
