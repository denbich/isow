...
return [
    ...
    'custom'               => [
        'pesel' => 'Даний номер PESEL недійсний.',
        'g-recaptcha-response' => [
            'required' => 'Будь ласка, переконайтеся, що ви не робот.',
            'captcha' => "Помилка Captcha! спробуйте пізніше або зв'яжіться з адміністратором сайту.",
        ],
        'oauth' => [
            'notfound' => "Не вдається знайти обліковий запис, пов'язаний з цим обліковим записом Google.",
            'error' => "Помилка Google! спробуйте пізніше або зв'яжіться з адміністратором сайту.",
        ],
        'email2fa' => [
            'expired' => 'Термін дії коду минув! Ми надіслали новий на електронну пошту. ',
            'wrong' => 'Код невірний!',
        ],
    ],
];
